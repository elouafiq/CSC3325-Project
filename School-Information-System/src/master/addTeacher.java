...
public class addTeacher extends JFrame {
  ...
  void jbInit() throws Exception {
    ...
    jTextField12.setBounds(new Rectangle(269, 126, 125, 22));
    jTextField12.addActionListener(new addTeacher_jTextField12_actionAdapter(this));
    jTextField12.addKeyListener(new addTeacher_jTextField12_keyAdapter(this));
    jLabel7.setBounds(new Rectangle(128, 103, 63, 17));
...
FileInputStream fis = new FileInputStream(path);
  ...
  while(fis.available() > 0)
    lists.add((Teacher) in.readObject());
...
class addTeacher_jTextField4_actionAdapter implements java.awt.event.ActionListener {
  addTeacher adaptee;

  addTeacher_jTextField4_actionAdapter(addTeacher adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class addTeacher_jTextField12_actionAdapter implements java.awt.event.ActionListener {
  addTeacher adaptee;

  addTeacher_jTextField12_actionAdapter(addTeacher adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
