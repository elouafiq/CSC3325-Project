...
public class Class  implements java.io.Serializable {
	...
	private Vector listOfStudents;
        public int students_per_section;
        public int number_of_professors;
	...
	public Class(String id){
        ...
        public void setstudpsec(int k){
          this.students_per_section=k;
        }
        public void profpersec(int k){
         this.number_of_professors=k;
}
       public void numsec(int k){
         this.numberOfSections=k;
       }
